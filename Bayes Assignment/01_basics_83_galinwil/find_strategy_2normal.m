...
Coef = zeros(1,3);
Coef(1) = (1/(2*distribution1.Cov)-1/(2*distribution2.Cov))
Coef(2) = -distribution1.Mean/(distribution1.Cov)+ (distribution2.Mean/(distribution2.Cov))
Coef(3) = distribution1.Mean^2/(2*distribution1.Cov) - distribution2.Mean^2/(2*distribution2.Cov) - log(distribution1.Prior*distribution2.Sigma)+ log(distribution2.Prior*distribution1.Sigma)
