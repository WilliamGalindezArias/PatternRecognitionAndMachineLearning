...
% tengo  q cargar todos los datos y pasar por la rutina preconstruida
for iterator = digs
   digit = iterator 
...
% saveas(gcf, 'error_evolution.png');
% 
...
% figure;
% imshow(mask);
% saveas(gcf,  'weak_classifiers.png');
% 
